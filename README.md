...
```javascript
import FLOAT64_PRECISION from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-precision@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float64-precision/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-float64-precision/actions/workflows/test.yml?query=branch:v0.1.1
